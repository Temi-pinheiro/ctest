    ...
    <div className='flex md:min-h-screen flex-col pt-20'>
      <div className='max-w-[1040px] mx-auto w-full max-md:px-6 flex flex-col md:mt-20 gap-y-6 max-md:pb-10'>
        ...
        <p className='text-black/70 max-md:text-sm text-xl'>
          ...
          urna mattis sodales. Auctor scelerisque feugiat morbi vitae commodo
          euismod faucibus nam volutpat.
          <br />
          <br /> In egestas pellentesque sagittis facilisi egestas. Orci a sit
          ...
          enim risus quis quam diam enim nisi et. Sed dui auctor laoreet vitae
          elit. Nunc interdum consequat egestas ornare nunc. Sapien viverra
          purus non et.
          <br />
          <br /> In egestas pellentesque sagittis facilisi egestas. Orci a sit
          tortor egestas sed. Ut tincidunt eget cursus sodales praesent cras
