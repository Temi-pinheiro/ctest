export const Details = () => {
  return (
    <div className='flex flex-col px-[10px]'>
      ...
      <div className='grid grid-cols-3 mt-12 gap-x-10'>
        ...
        <div className='flex flex-col items-center px-5 gap-y-6 h-full py-3 rounded-md'>
          ...
          <ul className='text-black/70 flex flex-col gap-y-2'>
        ...
        <div className='flex flex-col items-center px-5 gap-y-6 h-full py-3 rounded-md'>
          ...
          <p className='text-black/70 flex flex-col gap-y-5 items-start text-left w-full'>
            <span>
